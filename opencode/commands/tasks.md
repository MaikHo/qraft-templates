...
- path/to/another/file.razor – UI component for data submission
- path/to/another/file.razor.cs – Component code-behind / orchestration
- path/to/another/file.tests.cs – Unit tests for another/file
- src/Shared/Helpers/CalculationHelpers.cs – Utility functions needed for calculations
- tests/Shared/Helpers/CalculationHelpersTests.cs – Unit tests for helper logic

Notes

- Unit tests should typically be placed alongside the code files they are testing.
- Use `dotnet test` (or scoped test project path) to run tests.
