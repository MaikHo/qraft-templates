...
4. **Framework-Specific Issues**
   - Blazor: unnecessary re-renders, heavy lifecycle work, state churn
   - AvaloniaUI: property-change loops, binding inefficiencies
   - .NET backend: blocking calls in async paths, missing cancellation
   - Database: N+1 queries, missing indexes
   - Frontend/UI: rendering cost, asset optimization
