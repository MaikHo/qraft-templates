...
**Examples**:
- "What are the Blazor/Avalonia patterns?"
...
2. `.opencode/context/core/standards/tests.md` - Testing standards and quality gates
3. `.opencode/context/development/clean-code.md` - Additional development guidelines
